...
def main():
    ...
    tokenizer = CLIPTokenizer.from_pretrained(pretrained_model_name_or_path="clip-vit-base-patch32")
    text_encoder = CLIPTextModel.from_pretrained(pretrained_model_name_or_path="clip-vit-base-patch32")
