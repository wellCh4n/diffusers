...
def main():
    ...
    tokenizer = CLIPTokenizer.from_pretrained(pretrained_model_name_or_path="jinaai/jina-clip-v2")
    text_encoder = CLIPTextModel.from_pretrained(pretrained_model_name_or_path="jinaai/jina-clip-v2")
